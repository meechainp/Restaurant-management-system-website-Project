        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="staff_charged.php">Charged</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <a href="staff_order_history.php" class="list-group-item">ประวัติออเดอร์</a>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . "<a href='staff_order_db.php?ID=" . $row['orderId'] . "'>เสิร์ฟ</a>" . "</td> ";
                            echo "<td>" . "<a href='staff_order_menu.php?ID=" . $row['orderId'] . "'>ดูเมนู</a>" . "</td> ";
                            echo "</tr>";
                        }
