        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <a href="chef_order_history.php" class="list-group-item">ประวัติออเดอร์</a>
                </div>
            ...
            <div class="col-lg-9">
                ...
                $query = "SELECT orders.staffId, 
                            ...
                            orderStatus
                FROM orders, tables
                WHERE  orders.tableId = tables.tableId
                    AND orderStatus = 'Doing' 
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . "<a href='chef_order_menu.php?ID=" . $row['orderId'] . "'>ดูเมนู</a>" . "</td> ";
                            echo "</tr>";
                        }
