        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <a href="staff_order.php" class="list-group-item">ถอยกลับ</a>
                </div>
            ...
            <div class="col-lg-9">
                ...
                WHERE orderStatus = 'Served'
                    AND staffId = $staffId 
                ORDER BY orderStatus,orderId ASC"
          ...
          <th>ดูเมนู</th>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . "<a href='staff_order_history_menu.php?ID=" . $row['orderId'] . "'>ดูเมนู</a>" . "</td> ";
                            // echo "<td>" . "<a href='show_orderServe.php?orderId=" . $row['orderId'] . "'>เสิร์ฟ</a>" . "</td> ";
                            echo "</tr>";
                        }
